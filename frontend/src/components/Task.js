...
function Task() {
 ...
 <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">                <h1 className='text-xl text-gray-800 flex justify-start items-center space-x-2.5'>
            ...
            >
                <div className="md:flex md:flex-row md:gap-4">
                    {Object.entries(columns).map(([columnId, column], index) => {
                        ...
                        return (
                            <div
                            className="w-full md:w-[calc(25% - 1rem)]"
                                key={columnId}
                            >
                                        ...
                                        {(provided, snapshot) => {
                                            return (
                                                <div
                                                    ...
                                                    className={`  pt-4 duration-75 transition-colors border-t-2 border-indigo-400 md:min-h-full ${snapshot.isDraggingOver && 'border-indigo-600'}`}
                                                >
