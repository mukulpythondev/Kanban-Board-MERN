...
const AddProjectModal = ({ isModalOpen, closeModal, edit = false, id = null }) => {
    ...
    <Dialog as='div' open={isModalOpen} onClose={() => closeModal()} className="relative z-50">
        <div className="fixed inset-0 overflow-y-auto">
            ...
            <div className="fixed inset-0 flex items-center justify-center p-2 sm:p-4 w-screen h-screen"> {/* Adjusted padding */}
                <Transition.Child
                    as={Fragment}
                    enter="ease-out duration-300 "
                ...
                >
                    <Dialog.Panel className="rounded-md bg-white w-11/12 sm:w-6/12"> {/* Adjusted width */}
                        ...
                        <form onSubmit={handleSubmit} className='gap-2 px-4 sm:px-8 py-2 sm:py-4'> {/* Adjusted padding */}
